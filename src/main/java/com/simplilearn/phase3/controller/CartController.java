...
import com.simplilearn.phase3.model.Customer;
import com.simplilearn.phase3.model.Products;
import com.simplilearn.phase3.model.Purchase;
import com.simplilearn.phase3.service.CartService;
import com.simplilearn.phase3.service.CustomerService;
import com.simplilearn.phase3.service.PurchaseService;
		...
		public String buyProducts(@RequestParam("pm") String pm, HttpSession session) {
			...
			if(pm.equals("yes")) {
				...
				for(Cart cl:cartList) {
					...
					purchase.setId(cl.getProductId());
